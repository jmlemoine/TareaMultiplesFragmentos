package com.example.tareamultiplesfragmentos.Fragmentos;
 ...
 * {@link FragmentoRojo.OnFragmentInteractionListener} interface
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnRojo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getContext(), "Presionando Rojo", Toast.LENGTH_LONG).show();
